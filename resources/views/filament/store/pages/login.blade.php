<div class="flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden" style="min-height: 100vh; padding: 1.5rem 0;">
    <!-- Animated background -->
    ...
    <div class="relative z-10 w-full max-w-sm mx-auto px-6">
        <div class="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl p-4 border-0">
            <div class="mb-3 text-center">
                ...
                <p class="text-slate-300 text-sm">Sign in to manage your store inventory</p>
            </div>
            ...
            <form wire:submit="authenticate" class="space-y-2.5">
                ...
                <div class="flex items-center justify-between text-xs pt-0">
                    <label class="flex items-center gap-1.5 cursor-pointer group">
                        <input type="checkbox" wire:model="data.remember" class="w-3 h-3 rounded border-slate-600 bg-slate-800 text-purple-600 focus:ring-purple-500 focus:ring-offset-slate-900">
                ...
                <button type="submit" class="sign-in-btn w-full text-white font-semibold py-2 px-4 rounded-xl shadow-lg text-sm mt-2" style="background: linear-gradient(to right, #38bdf8, #3b82f6) !important; border: none !important; color: white !important; transition: all 0.3s ease !important; cursor: pointer !important;">
                    Sign In
                </button>
            </form>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-slate-400">
                    ...
                    <a href="{{ route('store.register') }}" class="text-purple-400 hover:text-purple-300 font-medium">
                        Register your store
                    </a>
                </p>
            </div>
